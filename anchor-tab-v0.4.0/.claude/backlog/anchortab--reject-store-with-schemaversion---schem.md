...
# AnchorTab: reject store with schemaVersion > SCHEMA_VERSION on read + ADR

## Goal
Protect against accidental v2→v1 downgrade clobber

## Context
Arch review #6. profiles-repo.readStore should throw when read-side schemaVersion exceeds current; write ADR capturing the policy.
