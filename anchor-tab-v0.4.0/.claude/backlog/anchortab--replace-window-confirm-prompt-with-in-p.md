...
# AnchorTab: replace window.confirm/prompt with in-page modals

## Goal
UI consistency with existing conflict-modal

## Context
Arch review future work. options-view uses window.confirm for delete/overwrite; migrate to modal component.
