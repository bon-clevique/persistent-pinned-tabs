...
# AnchorTab: apply rollback on partial failure

## Goal
No half-applied window state when apply throws mid-way

## Context
Arch review #5. Use try/finally to remove created tabs and unregister profile if applyProfile throws.
