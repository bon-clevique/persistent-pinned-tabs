...
# AnchorTab: engine (capture/apply) Vitest coverage via extended chrome-mock

## Goal
Regression coverage for applyProfile behavior matrix (ordering, skip, ProfileInUseError, stale recovery)

## Context
Arch review #9. Extend tests/chrome-mock.js with tabs.* and tabGroups.* stubs; 200-300 LOC mock + 150 LOC tests.
