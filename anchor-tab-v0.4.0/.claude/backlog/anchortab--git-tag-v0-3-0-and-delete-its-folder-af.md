...
# AnchorTab: git-tag v0.3.0 and delete its folder after v0.4.0 stabilizes

## Goal
Single live codebase; rely on git tag for rollback

## Context
Arch review #10. Two live folders = divergence risk for future security fixes.
