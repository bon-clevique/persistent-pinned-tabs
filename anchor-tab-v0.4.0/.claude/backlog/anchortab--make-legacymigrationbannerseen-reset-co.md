...
# AnchorTab: make legacyMigrationBannerSeen reset conditional on actual legacy data

## Goal
Do not re-show migration banner to users who already dismissed it

## Context
Code review SHOULD-FIX-5. Currently forced to false on every migration run regardless of whether persistentTabs was found.
